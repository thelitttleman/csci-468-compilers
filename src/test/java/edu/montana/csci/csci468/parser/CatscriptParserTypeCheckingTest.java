...
public class CatscriptParserTypeCheckingTest extends CatscriptTestBase {
    ...
    void returnTypeError() {
        ...
        assertEquals(ErrorType.INCOMPATIBLE_TYPES, getParseError("function foo() : bool {return 1}"));
        // must return something
        assertEquals(ErrorType.INCOMPATIBLE_TYPES, getParseError("function foo() : bool {return}"));
        // int is not compatible with void
        assertEquals(ErrorType.INCOMPATIBLE_TYPES, getParseError("function foo() {return 1}"));
    }
